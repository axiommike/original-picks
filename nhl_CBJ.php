    ...
    <header class="banner">
        ...
        <div class="w3-responsive">
            <div class="title-logo">
                ...
                <img src="images/cbj_logo.png" alt="Title Logo">
            </div>

            <!--====== Table Pagination ======-->
            <div class="w3-bar w3-transparent">
                <a href="nhl_COL.php" class="w3-button w3-text-black">&#10094; Previous</a>
                <a href="nhl_DAL.php" class="w3-button w3-right w3-text-black">Next &#10095;</a>
            </div>
