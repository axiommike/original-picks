    ...
    <header class="banner">
        ...
        <div class="w3-responsive">
            <div class="title-logo">
                ...
                <?php $teamName = 'Pittsburgh Penguins'; ?>
                <?php include 'contracts_caphit.php'; ?>

                <div class="team-info">
                    <h3><strong>Coach:</strong> <i>Dan Muse</i></h3>
                    <h3><strong>General Manager:</strong> <i>Kyle Dubas</i></h3>
                 </div>  
            ...
            <div class="w3-bar w3-transparent">
                <a href="nhl_PHI.php" class="w3-button w3-text-black">&#10094; Philadelphia Flyers</a>
                <a href="nhl_SJS.php" class="w3-button w3-right w3-text-black">San Jose Sharks &#10095;</a>
            </div>
