...
<head>
    ...
    <title>St. Louis Blues - NHL Rosters - NHL Original Picks</title>
</head>
    ...
    <header class="banner">
        ...
        <div class="w3-responsive">
            ...
            <div class="w3-bar w3-transparent">
                <a href="nhl_SEA.php" class="w3-button w3-text-black">&#10094; Seattle Kraken</a>
                <a href="nhl_TBL.php" class="w3-button w3-right w3-text-black">Tampa Bay Lightning &#10095;</a>
            </div>
