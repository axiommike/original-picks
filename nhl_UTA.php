    ...
    <header class="banner">
        ...
        <div class="w3-responsive">
            <div class="title-logo">
                ...
                <?php $teamName = 'Utah Mammoth'; ?>
                <?php include 'contracts_caphit.php'; ?>

                <div class="team-info">
                    <h3><strong>Coach:</strong> <i>Andre Tourigny</i></h3>
                    <h3><strong>General Manager:</strong> <i>Bill Armstrong</i></h3>
                 </div>  
            ...
            <div class="w3-bar w3-transparent">
                <a href="nhl_TOR.php" class="w3-button w3-text-black">&#10094; Toronto Maple Leafs</a>
                <a href="nhl_VAN.php" class="w3-button w3-right w3-text-black">Vancouver Canucks &#10095;</a>
            </div>
