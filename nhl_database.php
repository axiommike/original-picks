    ...
    <header class="banner">
        ...
        <div class="w3-responsive">
            ...
            <div class="w3-bar w3-transparent">
                <a href="free_agents.php" class="w3-button w3-right w3-text-black">Next &#10095;</a>
            </div>
            ...
            <table class="w3-table table-sortable w3-bordered w3-hoverable" id="myTable" style="width:100%">
                ...
                <tbody class="w3-text-black w3-centered" id="tableContent">
                    ...
                    $stmt = $pdo->query('SELECT * FROM nhl_player_data ORDER BY nhlRating DESC, capHit DESC, term DESC');
