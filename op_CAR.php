...
<body>
    ...
    <header class="banner">
        ...
        <div class="w3-responsive">
            ...
            <!--====== Forwards Table ======-->
            <?php generateOriginalPickTable($pdo, 'Carolina Hurricanes', 'F', 40, 'Forwards', 6); ?>

            <!--====== Defensemen Table ======-->
            <?php generateOriginalPickTable($pdo, 'Carolina Hurricanes', 'D', 20, 'Defensemen', 3); ?>

            <!--====== Goalies Table ======-->
            <?php generateOriginalPickTable($pdo, 'Carolina Hurricanes', 'G', 10, 'Goalies', 1); ?>
