    ...
    <header class="banner">
        ...
        <div class="w3-responsive">
            <div class="title-logo">
                <h2>PWHL Ottawa</h2>
                <img src="images/pwhlOTT_logo.png" alt="Title Logo">
            </div>

            <!--====== Table Pagination ======-->
            <div class="w3-bar w3-transparent">
                <a href="pwhl_NY.php" class="w3-button w3-text-black">&#10094; Previous</a>
                <a href="pwhl_TOR.php" class="w3-button w3-right w3-text-black">Next &#10095;</a>
            </div>
