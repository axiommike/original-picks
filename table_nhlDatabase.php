...
function generateTable($pdo, $title)
{
    ...
    $stmt = $pdo->prepare('SELECT * FROM nhl_player_data ORDER BY nhlRating DESC, capHit DESC, term DESC');
    $stmt->execute();
    ...
    echo "<tr><th class='w3-left-align'>&nbsp;&nbsp;&nbsp;Player Name</th><th class='w3-center'>Jersey</th><th class='w3-center'>Signed Team</th><th class='w3-center'>Drafted Team</th><th class='w3-center'>Draft Year</th><th class='w3-center'>Original Pick</th><th class='w3-center'>Cap Hit</th><th class='w3-center'>Position</th><th class='w3-center'>NHL Rating</th></tr>";
    echo "</thead>";
