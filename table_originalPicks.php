...
{
    $stmt = $pdo->prepare('SELECT * FROM nhl_player_data WHERE originalPick = :originalPick AND position = :position ORDER BY nhlRating DESC, capHit DESC, term DESC LIMIT :limit');
    ...
    echo "<tr><th class='w3-left-align'>&nbsp;&nbsp;&nbsp;Player Name</th><th class='w3-center'>Jersey</th><th class='w3-center'>Signed Team</th><th class='w3-center'>Cap Hit</th><th class='w3-center'>Term</th><th class='w3-center'>Rights</th><th class='w3-center'>NHL Rating</th></tr>";
    echo "</thead>";
